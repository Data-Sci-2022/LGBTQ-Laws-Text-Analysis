...
```{r loading_files}
# pro
pro_files <- list.files(path = '/Users/mackcampbell/Desktop/LGBTQ-Laws-Text-Analysis/data/State-Bill-csvs/Pro/', pattern = '.csv', full.names = T)

# anti
anti_files <- list.files(path = '/Users/mackcampbell/Desktop/LGBTQ-Laws-Text-Analysis/data/State-Bill-csvs/Anti/', pattern = '.csv', full.names = T)
```
...
billtrack_df %>% 
  write.csv('/Users/mackcampbell/Desktop/LGBTQ-Laws-Text-Analysis/data/billtrackdf.csv', row.names = T)
```
...
# saving the tibble into a csv to avoid future scraping
billtrack_df %>% 
  write.csv('/Users/mackcampbell/Desktop/LGBTQ-Laws-Text-Analysis/data/statetextdf.csv', row.names = T)
```
